...
% Name of BSP
BSP_Info.Name = 'BetaFlight';

BSP_Info.Version = '001';

% Data import function name
BSP_Info.importFcn = {'BetaFlight .bbl File'  , 'import_betaflight_file';
                      'BetaFlight .bbl Folder', 'import_betaflight_folder'};
